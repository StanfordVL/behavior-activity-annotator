...
<p style={{ marginLeft: "30px" }}>
Example basic condition: <img alt="Basic two-object condition" src={basic_binary_condition_image} width="275"/>
</p>
...
<p>
As you can see, basic conditions are simple sentences. If you were to take anything away, they would no longer be complete sentences. However, they can definitely be part of larger sentences that express more interesting ideas. Here are ways to make composed conditions.  
</p>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="Disjunction condition" src={disjunction_image} width="310"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="Conjunction condition" src={conjunction_image} width="310"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="Implication condition" src={implication_image} width="310"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="Composed implication and conjunction" src={composed_example_image} width="370"/>
</p> 
...
<p style={{ marginLeft: "30px"}}>
Example composed condition: <img alt="Negation condition" src={negation_image} width="250"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p>
    <b>Important note:</b> Basic condition blocks will allow you to use categories in them instead of object instances, as you'll see in the following examples. Make sure not to use a category in a basic condition without putting that basic condition into a composer that has a category - this would make your conditions ambiguous, and we wouldn't be able to use them. 
</p>
<p>
    After learning about the composers with categories, look at the notes at the end to learn about important uses of these composers.
</p>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="For all condition" src={universal_image} width="380" />
</p>
<p style={{ marginLeft: "30px" }}>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="There exists condition" src={existential_image} width="530"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="Combined category composers" src={quantified_combo_image} width="640"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="For N condition" src={forn_image} width="400"/>
</p>
<p style={{ marginLeft: "30px" }}>
...
<p>
The <b>for N pairs of</b> condition composer takes a counting number N, two categories, and a basic condition, and says the basic category has to be true for N pairs of objects from the categories. Note that this isn't as safe as <b>for pairs</b> - see the note right below.  
</p>    
<p style={{ marginLeft: "30px" }}>
Example composed condition: <img alt="For N pairs condition" src={fornpairs_image} width="520"/>
</p>
<p style={{ marginLeft: "30px" }}>
This means that two apples have to be inside shelf1, but it doesn't matter which apples. 
</p>
