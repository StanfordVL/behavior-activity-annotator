...
export default class ConditionWritingInstructions extends React.Component {
...
<h6 className="text-muted"><b>for all pairs of</b> first_cateogry, second_category, basic_condition</h6>    
<p>
